...
# ═════════════════════════════════════════════════════════════════════
# IMPORTANTE: nei tuoi secrets.toml usa il Connection Pooler di Supabase
# (porta 6543, non 5432) per evitare l'errore IPv6 "Cannot assign requested address"
#
# Esempio secrets.toml corretto:
# [postgresql]
        ...
        if st.button("🚀 Riversa CSV nel Database", use_container_width=True):
            ...
            if os.path.exists(CSV_FILE):
                ...
                try:
                    ...
                    # FIX: chiude sempre le connessioni del engine temporaneo
...
try:
    ...
    st.warning(
        "Nessun dato trovato o tabella non ancora pronta su Supabase. "
